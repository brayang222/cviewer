...
// Query: *[_type == 'startup' && _id == $id][0]{  _id,  title,  slug,  _createdAt,  author -> {  _id, username, name, image, bio  },  views,  description,  category,  image,  pitch}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n    *[_type == 'startup' && _id == $id][0]{ _id, views }": STARTUP_VIEWS_QUERYResult;
